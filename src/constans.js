export const BTN_LOGOUT_TEXT = 'Logout';
...
export const BTN_REMOVE_AUTHOR_TEXT = 'Remove author';

export const INPUT_SEARCH_TEXT = 'Enter course name...';
export const INPUT_ENTER_TITLE_TEXT = 'Enter title...';
export const INPUT_ENTER_AUTHOR_NAME_TEXT = 'Enter author name...';
export const INPUT_ENTER_DURATION_TEXT = 'Enter duration in minutes...';
export const INPUT_TYPE_SEARCH = 'search';
export const TEXTAREA_DESCRIPTION_TEXT = 'Enter description...';
